  ...
  return (
    <main className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Student Data Setup</h1>
        <p className="text-gray-600 mb-8">
          Add students by selecting an institution and course, then enter student details manually, via CSV, or via API.
        </p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mt-6">
              <>
                <p className="text-sm text-gray-600 mb-4">
                  Adding students to: <strong>{getCourseName(selectedCourse)}</strong>
                  <br />
