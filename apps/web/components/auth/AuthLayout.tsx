...
export function AuthLayout({
  ...
  return (
    <main
      className={`relative flex min-h-dvh items-start justify-center overflow-x-hidden bg-gradient-to-br ${styles.page} px-4 py-6 sm:items-center sm:px-6 sm:py-10`}
    >
      <div
        className={`pointer-events-none absolute -left-24 -top-24 h-72 w-72 rounded-full blur-3xl ${styles.glow}`}
      />
      <div
        className={`pointer-events-none absolute -bottom-32 -right-16 h-96 w-96 rounded-full blur-3xl ${styles.glow}`}
      />
