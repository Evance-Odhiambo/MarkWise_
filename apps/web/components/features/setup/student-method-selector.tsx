...
import type { ImportMethod } from "../../../types/setup-student";
...
const methods: {
...
}[] = [
  {
    value: "manual",
    label: "Manual Entry",
    description: "Add student records individually with admission numbers",
    icon: PlusCircle,
  },
  {
    value: "csv",
    label: "CSV Batch Ingest",
    description: "Upload structured student roster for this course",
    icon: FileText,
  },
  {
    value: "api",
    label: "Student Information API",
    description: "Live sync student cohort from campus SIS system",
    icon: Server,
  },
];
