    ...
    <SafeAreaView className={`flex-1 ${screenClasses}`}>
      <ScrollView className="flex-1 px-5 py-6" contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View className="mt-6 space-y-3">
          {[
            { icon: Bell, label: 'Notifications', desc: 'Manage class alerts', accent: 'bg-amber-100', accentDark: 'bg-amber-500/20' },
            { icon: Shield, label: 'Security', desc: 'Faculty access controls', accent: 'bg-blue-100', accentDark: 'bg-blue-500/20' },
            { icon: CircleHelp, label: 'Support', desc: 'Documentation and help centre', accent: 'bg-violet-100', accentDark: 'bg-violet-500/20' },
